...
def check_for_update():
    ...
    if (
        not os.path.isfile("data/pokemon_data.json")
        or not os.path.isfile("data/fast_moves.json")
        or not os.path.isfile("data/charged_moves.json")
        or not os.path.isfile("data/shiny_data.json")
        or not os.path.isfile("data/invasions.json")
    ):
